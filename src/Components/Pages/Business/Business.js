            ...
            <div className="flex flex-col items-center sm:px-5 md:flex-row">
                ...
                <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                    <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                        ...
                        <h1 className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl"><a href="#_">Savory Cupcakes.</a></h1>
                    ...
                    <div className="box-border w-full text-black border-solid md:pl-10 md:order-none">
                        ...
                        <ul className="p-0 m-0 leading-6 border-0 border-gray-300">
                            { weekHours.map( day=>{
                                ...
                                <span className="inline-flex items-center justify-center w-6 h-6 mr-2"><span className="text-sm font-bold">{day.day}</span></span> <span className="ml-24">{day.hours}</span>
                            </li>
                            })}
