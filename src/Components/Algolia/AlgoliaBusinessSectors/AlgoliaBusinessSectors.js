...
import { currentBussinessCategory, localeState, searchQueryState } from "../../../context/appState";
...
export default function AlgoliaBusinessSectors(props) {
  ...
  const navigate = useNavigate();
    ...
    return <InstantSearch searchClient={qrySuggestClient} indexName="BusinessSectorPage">
            <CustomAutocomplete placeholder={placeholder} btnText={searchText?.button} showSuggestions={showSuggestions} handleSearch={handleSearch} qryChange={qryChange} dropSelect={dropSelect}/>
          </InstantSearch>          
