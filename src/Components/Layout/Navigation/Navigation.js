...
return  <section className="w-full px-8 text-gray-700 bg-white">
        <div className="container w-full flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
            <div className="relative flex flex-col md:flex-row sm:w-2/5 w-4/5">
                ...
                <nav className="flex flex-wrap w-full self-center justify-end mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
                ...
                <div className="inline-flex items-center ml-5 space-x-6 lg:justify-end">
                    <Link to="/contact" className="bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded">
