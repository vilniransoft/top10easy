...
function App() {
  ...
  return (
    ...
    />
      ...
      <div className="main">
      <div style={{backgroundImage: `url("/02Main.png")`, backgroundRepeat: 'no-repeat',backgroundPosition: 'center center', backgroundSize: 'cover',  height: '45vh'}} className="city-image-banner bg-gray-400 w-full  bg-no-repeat bg-cover">
      </div>
      <Routes>
